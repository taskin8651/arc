    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.site-settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('footer_text') ? 'is-invalid' : '' }}" type="text" name="footer_text" id="footer_text" value="{{ old('footer_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_analytics_code') ? 'is-invalid' : '' }}" type="text" name="google_analytics_code" id="google_analytics_code" value="{{ old('google_analytics_code', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('loction_url') ? 'is-invalid' : '' }}" name="loction_url" id="loction_url">{{ old('loction_url') }}</textarea>
