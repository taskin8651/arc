    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conclusion') ? 'is-invalid' : '' }}" type="text" name="conclusion" id="conclusion" value="{{ old('conclusion', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_area') ? 'is-invalid' : '' }}" type="text" name="site_area" id="site_area" value="{{ old('site_area', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_space') ? 'is-invalid' : '' }}" type="text" name="project_space" id="project_space" value="{{ old('project_space', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_manpower') ? 'is-invalid' : '' }}" type="text" name="total_manpower" id="total_manpower" value="{{ old('total_manpower', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estimate_cost') ? 'is-invalid' : '' }}" type="text" name="estimate_cost" id="estimate_cost" value="{{ old('estimate_cost', '') }}">
